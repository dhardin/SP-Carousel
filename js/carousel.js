...
var carousel = (function() {
    ...
    var
        configMap = {
            main_html: String() + '<div class="barousel_image"></div>' + '<div class="barousel_content"><div class="default"><h4>Loading...</h4><p></p></div></div>' + '<div class="barousel_nav"></div>',
            settable_map: {
                fake: true,
                listGuid: true,
                viewGuid: true,
        ...
        jqueryMap = {},
        setJqueryMap, getData, configModule, setConfigMap, initModule, endsWith, printError, processData, processResult, populateCarousel, stripHtml;
    ...
    printError = function(XMLHttpRequest, textStatus, errorThrown) {
        ...
        var $contentContainer = jqueryMap.$contentContainer;
    ...
    populateCarousel = function(items) {
        var $imageContainer = jqueryMap.$imageContainer,
            ...
            i, $img, $content, $body, $date, $header, imgSrc, imgAlt, linkSrc;
        ...
        for (i = 0; i < items.length; i++) {
            ...
            $header.html(items[i].rich_title && items[i].rich_title.length > 0 ? items[i].rich_title : items[i].title);
